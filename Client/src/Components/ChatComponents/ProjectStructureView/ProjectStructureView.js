...
import './ProjectStructureView.scss';
...
export const ProjectStructureView = ({ data }) => {
  console.log(data);
  return (
    <RichTreeView
      items={data}
      className="project-structure-view"
      aria-label="file explorer"
      defaultExpandedItems={[data[0]?.id, data[0]?.children[0]?.id]}
      defaultSelectedItems={[data[0].id]}
